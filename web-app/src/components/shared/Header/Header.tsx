...
export function Header() {
  ...
  return <header className="flex min-h-16 items-center justify-between border-b border-slate-200 bg-white px-4 sm:px-6">
    <div className="flex items-center gap-3"><button type="button" className="button-secondary h-9 min-h-0 px-2 md:hidden" aria-label="Open navigation" onClick={openMobileSidebar}>Menu</button><h1 className="text-lg font-semibold text-slate-900">{title}</h1></div>
